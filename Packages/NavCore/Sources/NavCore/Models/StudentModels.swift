...
public extension SearchSuggestions {
    private static let demoUniversities: [TrendingUniversity] = [
        ...
        TrendingUniversity(id: "2", name: "MIT", studentCount: 218),
        TrendingUniversity(id: "3", name: "NUS", studentCount: 156),
        TrendingUniversity(id: "4", name: "BITS Pilani", studentCount: 289),
        TrendingUniversity(id: "5", name: "IIT Delhi", studentCount: 312),
        TrendingUniversity(id: "6", name: "Stanford", studentCount: 97),
    ]
...
public extension StudentResult {
    static let demos: [StudentResult] = {
        let s1 = StudentResult(id: "s1", name: "Priya", age: 22, photos: ["https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400"], university: "IIT Bombay", universityTier: "Top Public", study: "Computer Science", city: "Mumbai", country: "India", distance: 2.3, bio: "Coffee lover, code writer", isVerified: true, canMessage: false, interactionStatus: "none")
        let s2 = StudentResult(id: "s2", name: "Rahul", age: 24, photos: ["https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400"], university: "BITS Pilani", universityTier: "Top Private", study: "Electrical Engineering", city: "Bangalore", country: "India", distance: nil, bio: "Building the future, one line at a time", isVerified: true, canMessage: false, interactionStatus: "none")
        let s3 = StudentResult(id: "s3", name: "Ananya", age: 23, photos: ["https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=400"], university: "NUS", universityTier: "Top Public", study: "Business Analytics", city: "Singapore", country: "Singapore", distance: nil, bio: "Globetrotter and bookworm", isVerified: false, canMessage: false, interactionStatus: "liked")
        let s4 = StudentResult(id: "s4", name: "Meera", age: 21, photos: ["https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400"], university: "IIT Delhi", universityTier: "Top Public", study: "Mathematics", city: "Delhi", country: "India", distance: 5.1, bio: "Music and math", isVerified: true, canMessage: true, interactionStatus: "matched")
        let s5 = StudentResult(id: "s5", name: "Rohit", age: 23, photos: ["https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400"], university: "IIT Bombay", universityTier: "Top Public", study: "Mechanical Engineering", city: "Mumbai", country: "India", distance: 3.5, bio: "Weekend biker, weekday coder", isVerified: true, canMessage: false, interactionStatus: "none")
        let s6 = StudentResult(id: "s6", name: "Anika", age: 21, photos: ["https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=400"], university: "IIT Bombay", universityTier: "Top Public", study: "Data Science", city: "Mumbai", country: "India", distance: 1.8, bio: "Data nerd with a travel bug", isVerified: true, canMessage: false, interactionStatus: "none")
        let s7 = StudentResult(id: "s7", name: "Sneha", age: 23, photos: ["https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400"], university: "BITS Pilani", universityTier: "Top Private", study: "Chemical Engineering", city: "Pilani", country: "India", distance: 12.0, bio: "Foodie and aspiring chef", isVerified: false, canMessage: false, interactionStatus: "none")
        let s8 = StudentResult(id: "s8", name: "Rohit Krishna", age: 25, photos: ["https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400"], university: "IIT Delhi", universityTier: "Top Public", study: "Physics", city: "Delhi", country: "India", distance: 4.2, bio: "Quantum physics meets guitar", isVerified: true, canMessage: false, interactionStatus: "none")
